    ...
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">欢迎回来</h1>
          <p className="text-gray-600 dark:text-gray-400">登录到你的账户</p>
        </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm p-8">
          ...
          <div className="mt-4">
            <div className="relative mb-4">
              ...
              <div className="relative flex justify-center text-xs"><span className="px-2 bg-white dark:bg-gray-800 text-gray-400 dark:text-gray-500">或使用第三方登录</span></div>
            </div>
          ...
          <div className="mt-6 text-center space-y-2">
            ...
            <p>
              <Link to="/forgot-password" className="text-sm text-gray-400 dark:text-gray-500 hover:text-primary transition">
                忘记密码？
              </Link>
            </p>
          </div>
