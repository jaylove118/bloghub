  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600">一个全功能的博客平台</p>
      </div>
      ...
      <div className="bg-gradient-to-r from-primary to-secondary rounded-2xl p-8 text-white text-center">
        ...
        <Link
          to="/register"
          className="inline-block px-8 py-3 bg-white text-primary font-semibold rounded-full hover:bg-gray-100 transition"
        >
          立即注册
        </Link>
      </div>
